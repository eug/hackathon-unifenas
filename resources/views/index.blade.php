            ...
            <form action="" class="toolbar-form" method="GET">
                ...
                <div class="form-row">
                    ...
                    <select class="form-control filter-input by-category" placeholder="Digite aqui">
                        ...
                        <option value=46.33-8-01">Comércio atacadista de frutas, verduras, raízes, tubérculos, hortaliças e legumes frescos</option>
                        <option value=47.59-8-99">Comércio varejista de outros artigos de uso pessoal e doméstico não especificados anteriormente</option>
                        ...
                        <option value=45.30-7-03">Comércio a varejo de peças e acessórios novos para veículos automotores</option>
                        <option value=82.19-9-99">Preparação de documentos e serviços especializados de apoio administrativo não especificados anteriormente</option>
                        ...
                        <option value=14.12-6-01">Confecção de peças de vestuário, exceto roupas íntimas e as confeccionadas sob medida</option>
                        ...
                        <option value=33.14-7-09">Manutenção e reparação de máquinas de escrever, calcular e de outros equipamentos não-eletrônicos para escritório</option>
                        <option value=56.11-2-02">Bares e outros estabelecimentos especializados em servir bebidas</option>
                        <option value=47.12-1-00">Comércio varejista de mercadorias em geral, com predominância de produtos alimentícios - minimercados, mercearias e armazéns</option>
                        <option value=46.35-4-99">Comércio atacadista de bebidas não especificadas anteriormente</option>
                        ...
                        <option value=93.29-8-99">Outras atividades de recreação e lazer não especificadas anteriormente</option>
                        <option value=45.20-0-03">Serviços de manutenção e reparação elétrica de veículos automotores</option>
                        <option value=47.54-7-01">Comércio varejista de móveis</option>
                        <option value=47.23-7-00">Comércio varejista de bebidas</option>
                        <option value=45.11-1-02">Comércio a varejo de automóveis, camionetas e utilitários usados</option>
                        ...
                        <option value=47.71-7-02">Comércio varejista de produtos farmacêuticos, com manipulação de fórmulas</option>
                        <option value=47.44-0-05">Comércio varejista de materiais de construção não especificados anteriormente</option>
                        <option value=47.21-1-02">Padaria e confeitaria com predominância de revenda</option>
                        <option value=45.30-7-01">Comércio por atacado de peças e acessórios novos para veículos automotores</option>
                        <option value=47.82-2-02">Comércio varejista de artigos de viagem</option>
                        <option value=95.21-5-00">Reparação e manutenção de equipamentos eletroeletrônicos de uso pessoal e doméstico</option>
                        <option value=47.71-7-01">Comércio varejista de produtos farmacêuticos, sem manipulação de fórmulas</option>
                        ...
                        <option value=47.72-5-00">Comércio varejista de cosméticos, produtos de perfumaria e de higiene pessoal</option>
                        ...
                        <option value=47.53-9-00">Comércio varejista especializado de eletrodomésticos e equipamentos de áudio e vídeo</option>
                        <option value=47.51-2-02">Recarga de cartuchos para equipamentos de informática</option>
                        <option value=45.20-0-07">Serviços de instalação, manutenção e reparação de acessórios para veículos automotores</option>
                        <option value=47.52-1-00">Comércio varejista especializado de equipamentos de telefonia e comunicação</option>
                        ...
                        <option value=47.51-2-01">Comércio varejista especializado de equipamentos e suprimentos de informática</option>
                        <option value=47.89-0-04">Comércio varejista de animais vivos e de artigos e alimentos para animais de estimação</option>
                        ...
                        <option value=47.56-3-00">Comércio varejista especializado de instrumentos musicais e acessórios</option>
                        <option value=47.89-0-99">Comércio varejista de outros produtos não especificados anteriormente</option>
                        ...
                        <option value=14.12-6-02">Confecção, sob medida, de peças do vestuário, exceto roupas íntimas</option>
                        <option value=33.12-1-03">Manutenção e reparação de aparelhos eletromédicos e eletroterapêuticos e equipamentos de irradiação</option>
                        ...
                        <option value=46.18-4-01">Representantes comerciais e agentes do comércio de medicamentos, cosméticos e produtos de perfumaria</option>
                        <option value=47.13-0-02">Lojas de variedades, exceto lojas de departamentos ou magazines</option>
                        ...
                        <option value=96.02-5-02">Atividades de estética e outros serviços de cuidados com a beleza</option>
                        <option value=47.63-6-03">Comércio varejista de bicicletas e triciclos; peças e acessórios</option>
                        <option value=47.29-6-99">Comércio varejista de produtos alimentícios em geral ou especializado em produtos alimentícios não especificados anteriormente</option>
                        <option value=47.89-0-01">Comércio varejista de suvenires, bijuterias e artesanatos</option>
                        <option value=32.40-0-03">Fabricação de mesas de bilhar, de sinuca e acessórios associada à locação</option>
                        ...
                        <option value=49.30-2-02">Transporte rodoviário de carga, exceto produtos perigosos e mudanças, intermunicipal, interestadual e internacional</option>
                        <option value=95.11-8-00">Reparação e manutenção de computadores e de equipamentos periféricos</option>
                        <option value=45.30-7-04">Comércio a varejo de peças e acessórios usados para veículos automotores</option>
                        ...
                        <option value=47.11-3-02">Comércio varejista de mercadorias em geral, com predominância de produtos alimentícios - supermercados</option>
                        <option value=46.91-5-00">Comércio atacadista de mercadorias em geral, com predominância de produtos alimentícios</option>
                        ...
                        <option value=47.11-3-01">Comércio varejista de mercadorias em geral, com predominância de produtos alimentícios - hipermercados</option>
                        ...
                        <option value=46.45-1-01">Comércio atacadista de instrumentos e materiais para uso médico, cirúrgico, hospitalar e de laboratórios</option>
                        <option value=46.31-1-00">Comércio atacadista de leite e laticínios</option>
                        <option value=82.30-0-01">Serviços de organização de feiras, congressos, exposições e festas</option>
                        <option value=46.89-3-99">Comércio atacadista especializado em outros produtos intermediários não especificados anteriormente</option>
                        <option value=47.84-9-00">Comércio varejista de gás liqüefeito de petróleo (GLP)</option>
                        <option value=47.57-1-00">Comércio varejista especializado de peças e acessórios para aparelhos eletroeletrônicos para uso doméstico, exceto informática e comunicação</option>
                        <option value=47.83-1-02">Comércio varejista de artigos de relojoaria</option>
                        <option value=47.29-6-01">Tabacaria</option>
                        <option value=95.29-1-99">Reparação e manutenção de outros objetos e equipamentos pessoais e domésticos não especificados anteriormente</option>
                        <option value=46.17-6-00">Representantes comerciais e agentes do comércio de produtos alimentícios, bebidas e fumo</option>
                        <option value=42.99-5-99">Outras obras de engenharia civil não especificadas anteriormente</option>
                        ...
                        <option value=10.91-1-02">Fabricação de produtos de padaria e confeitaria com predominância de produção própria</option>
                        <option value=47.63-6-02">Comércio varejista de artigos esportivos</option>
                        <option value=45.11-1-03">Comércio por atacado de automóveis, camionetas e utilitários novos e usados</option>
                        <option value=47.44-0-01">Comércio varejista de ferragens e ferramentas</option>
                        <option value=25.99-3-99">Fabricação de outros produtos de metal não especificados anteriormente</option>
                        ...
                        <option value=77.19-5-99">Locação de outros meios de transporte não especificados anteriormente, sem condutor</option>
                        ...
                        <option value=45.41-2-02">Comércio por atacado de peças e acessórios para motocicletas e motonetas</option>
                        <option value=47.59-8-01">Comércio varejista de artigos de tapeçaria, cortinas e persianas</option>
                        ...
                        <option value=29.49-2-99">Fabricação de outras peças e acessórios para veículos automotores não especificadas anteriormente</option>
                        <option value=18.22-9-01">Serviços de encadernação e plastificação</option>
                        <option value=45.20-0-01">Serviços de manutenção e reparação mecânica de veículos automotores</option>
                        ...
                        <option value=74.90-1-99">Outras atividades profissionais, científicas e técnicas não especificadas anteriormente</option>
